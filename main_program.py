...
line1 = Label(
    root, text="If you are suffering from various symptoms of COVID-19").pack()
line2 = Label(
    root, text="This program will try to calculate the odds you have it.").pack()
line3 = Label(
    root, text="Therefore, please input your symptoms or the intensity.").pack()
...
env_box = Checkbutton(root, text="Apakah anda tinggal di daerah berpopulasi?",
...
calc_button = tkinter.Button(
    root, text="Calculate risk of C19 Infection", command=Click).pack()
